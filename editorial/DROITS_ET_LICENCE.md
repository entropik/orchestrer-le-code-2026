# Droits d'auteur, Licence & Protection des Contenus
...
Le site officiel de publication et de référence est hébergé à l'adresse : [https://savoirs.keredit.com/](https://savoirs.keredit.com/).

---

## Licence de mise à disposition en ligne : CC BY-NC-ND 4.0
...
### Ce que vous êtes libre de faire :
- **Partager et diffuser** : Vous pouvez copier et redistribuer les extraits ou liens vers ce manuel sur tout support ou format à des fins d'information, d'enseignement ou de débat.

### Selon les conditions strictes suivantes :
1. **Attribution (BY)** : Vous devez obligatoirement créditer l'auteur (**Marc Tallec**), intégrer un lien direct vers l'œuvre originale ([https://savoirs.keredit.com/](https://savoirs.keredit.com/)) et indiquer si des citations ont été faites.
2. **Pas d'Utilisation Commerciale (NC)** : Vous n'êtes pas autorisé à faire un usage commercial de cette œuvre, de ses textes ou de ses parties, directement ou indirectement (vente d'e-books, inclusion dans une formation ou publication payante, diffusion sous paywall, monétisation publicitaire exclusive).
3. **Pas de Modification (ND)** : Si vous remixez, transformez, tronquez ou adaptez le texte pour créer une œuvre dérivée, vous n'êtes pas autorisé à distribuer l'œuvre modifiée sans l'accord écrit exprès de l'auteur.

Pour consulter le texte officiel de cette licence : [Creative Commons CC BY-NC-ND 4.0 Legal Code](https://creativecommons.org/licenses/by-nc-nd/4.0/legalcode.fr).
...
## Exception pour le code source et les exemples exécutables
...
* **Auteur** : Marc Tallec  
* **Plateforme** : Keredit Éditions / Savoirs ([https://savoirs.keredit.com/](https://savoirs.keredit.com/))

...
Pour qu'un module profond serve de rempart efficace au sein du [Harnais](/annexes/glossaire#harnais), son interface publique doit respecter quatre exigences formelles :
...
- L'Infrastructure dépend du Domaine (elle implémente les interfaces définies par les [Ports](/annexes/glossaire#port)).
...
**Décision de l'architecte** : Refus de la PR avec instruction de refactoring selon le modèle [Port](/annexes/glossaire#port) / Adaptateur :
...
- [ ] **Les points de couture existent** : Tous les services externes (disque, base, courriel, passerelle de paiement) sont modélisés par des [Ports](/annexes/glossaire#port) abstraits (`Protocol`).

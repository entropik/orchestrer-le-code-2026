{
  "title": "B04 — Donner du contexte et des limites à l'agent",
  "weight": 16,
  "source_path": "tranches/B04-harnais-et-contexte.md"
}

Statut : redaction. Chapitre rédigé conformément au périmètre, harmonisé avec le miroir A04.

## Mission

Rédiger la lecture ingénieure du thème 04 : Construire un contexte progressif, une mémoire versionnée et des limites exécutoires.

## Entrées

- [Chapitre à développer](/ingenieure/04-harnais-et-contexte).
- [Chapitre miroir](/accessible/04-harnais-et-contexte).
...
- Contexte stable, domaine, tâche et observations dynamiques.
- Carte du dépôt, symboles et inspection AST.
- Mémoire : provenance, fraîcheur et résolution des contradictions.
- Isolation, quotas et collecte des résultats.
...
- Exemple fil rouge : Spécifier un manifeste de contexte avec source, date, rôle et règle de mise à jour de chaque entrée.

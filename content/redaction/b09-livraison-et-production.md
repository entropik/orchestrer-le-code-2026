{
  "title": "B09 — Passer du poste local à un service réel",
  "weight": 21,
...
- [Chapitre à développer](/ingenieure/09-livraison-et-production).
- [Chapitre miroir](/accessible/09-livraison-et-production).

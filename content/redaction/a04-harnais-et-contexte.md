{
  "title": "A04 — Donner du contexte et des limites à l'agent",
  "weight": 4,
  "source_path": "tranches/A04-harnais-et-contexte.md"
}
...
Rédiger la lecture accessible du thème 04 : Préparer une session utile sans noyer l'agent ni lui donner carte blanche.

## Entrées

- [Chapitre à développer](/accessible/04-harnais-et-contexte).
- [Chapitre miroir](/ingenieure/04-harnais-et-contexte).
- [Charte éditoriale](/projet/charte).
- [Registre critique](/projet/references/registre-critique).
- Sources : O-MD §4, §5 ; I-MD §1.2 à §1.5, §10, §11.5. Les identifiants sont résolus dans l'[inventaire commenté](/projet/corpus).
- Prérequis de rédaction : A03 ; une amorce existante permet de commencer, une harmonisation des deux niveaux est exigée à la relecture.

## Périmètre

- Une carte du projet plutôt qu'un dossier entier collé.
- Mission, inspection, proposition et exécution.
- Mémoire durable des décisions.
- Arrêts utiles et compte rendu honnête.
...
- Exemple fil rouge : Préparer un dossier de mission et un compte rendu pour la même tranche.
...
- [ ] Le lecteur peut reprendre la tâche sans relire toute la conversation.

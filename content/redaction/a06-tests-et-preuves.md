{
  "title": "A06 — Demander des preuves, pas seulement du code",
  "weight": 6,
  "source_path": "tranches/A06-tests-et-preuves.md"
}
...
- [Chapitre à développer](/accessible/06-tests-et-preuves).
- [Chapitre miroir](/ingenieure/06-tests-et-preuves).

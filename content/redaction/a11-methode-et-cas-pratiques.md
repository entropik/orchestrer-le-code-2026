{
  "title": "A11 — Appliquer ORCHESTRE du besoin à la résolution",
  "weight": 11,
  "source_path": "tranches/A11-methode-et-cas-pratiques.md"
}
...
Rédiger la lecture accessible du thème 11 : Piloter une fonctionnalité puis une correction avec la même méthode de décision.

## Entrées

- [Chapitre à développer](/accessible/11-methode-et-cas-pratiques).
- [Chapitre miroir](/ingenieure/11-methode-et-cas-pratiques).
...
- Prérequis de rédaction : A10 ; une amorce existante permet de commencer, une harmonisation des deux niveaux est exigée à la relecture.

## Périmètre

- Les neuf étapes ORCHESTRE.
- Cas fil rouge : recevoir un PDF avec reprise.
- Cas incident : deux commandes pour une intention.
- Décider, accepter et transmettre le travail.
...
- Exemple fil rouge : Écrire le dialogue de pilotage de ces deux cas, avec les décisions d'acceptation.

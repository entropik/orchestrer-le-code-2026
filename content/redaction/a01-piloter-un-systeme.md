{
  "title": "A01 — Piloter un système, pas une génération de code",
  "weight": 1,
  "source_path": "tranches/A01-piloter-un-systeme.md"
}
...
Rédiger la lecture accessible du thème 01 : Savoir ce que l'on délègue à un agent et ce que l'on doit décider soi-même.

## Entrées

- [Chapitre à développer](/accessible/01-piloter-un-systeme).
- [Chapitre miroir](/ingenieure/01-piloter-un-systeme).
...
- Prérequis de rédaction : aucun ; une amorce existante permet de commencer, une harmonisation des deux niveaux est exigée à la relecture.

## Périmètre

- Le logiciel comme atelier : entrées, règles, données et résultat.
- Le rôle de l'orchestrateur : intention, limites et preuve.
- Prototype visible et service fiable : deux étapes différentes.
- Décider quand continuer et quand demander un arbitrage.
...
- Exemple fil rouge : Rédiger une mission pour analyser le dépôt de fichiers, sans modification ni publication.

{
  "title": "B11 — Appliquer ORCHESTRE du besoin à la résolution",
  "weight": 23,
...
Rédiger la lecture ingénieure du thème 11 : Raccorder la méthode de pilotage aux étapes techniques sans construire un cycle en cascade.

## Entrées

- [Chapitre à développer](/ingenieure/11-methode-et-cas-pratiques).
- [Chapitre miroir](/accessible/11-methode-et-cas-pratiques).
- [Charte éditoriale](/projet/charte) et [fil rouge](/projet/fil-rouge).
- [Registre critique](/references/registre-critique).
- Sources : O-MD §5, §11, §12, §13, §14 ; I-MD §9, §10. Les identifiants sont résolus dans l'[inventaire commenté](/projet/corpus).
- Prérequis de rédaction : A11, B10 ; une amorce existante permet de commencer, une harmonisation des deux niveaux est exigée à la relecture.

## Périmètre

- Correspondance ORCHESTRE et six phases KISS.
- Tranches verticales et sous-étapes de réalisation.
- Upload : session, droits, finalisation et reprise.
- Doublon : reproduction causale, contrainte, migration et observation.
...
- Exemple fil rouge : Produire deux dossiers de réalisation avec SPEC, ADR, matrice de tests et plan de livraison.

{
  "title": "B05 — Garder une histoire fiable avec Git",
  "weight": 17,
  "source_path": "tranches/B05-git-et-collaboration.md"
}

Statut : redaction. Chapitre rédigé conformément au périmètre, harmonisé avec le miroir A05.
...
- [Chapitre à développer](/ingenieure/05-git-et-collaboration).
- [Chapitre miroir](/accessible/05-git-et-collaboration).

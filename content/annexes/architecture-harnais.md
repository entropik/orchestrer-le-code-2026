{
  "title": "Architecture du harnais & Smart Zone",
  "source_path": "manuscrit/03-annexes/03-architecture-du-harnais.md",
  "weight": 3,
  "description": "Doctrine racine vs global, modèle 3 couches, gestion des tokens et règles d'or."
}
...
*Pour découvrir comment ces règles s'articulent dans les flux opérationnels, consulter le [Guide des workflows](/annexes/workflows). Pour explorer les fiches détaillées des 37 compétences, consulter le [Catalogue des skills](/annexes/catalogue-skills).*

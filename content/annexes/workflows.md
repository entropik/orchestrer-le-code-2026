{
  "title": "Guide des workflows & Cas pratiques",
  "source_path": "manuscrit/03-annexes/02-guide-des-workflows.md",
  "weight": 2,
  "description": "Le ruban principal, l'arbre d'aiguillage et les 7 trames d'exécution pas à pas.",
  "aliases": [
    "/annexes/workflows-agentiques"
  ]
}
...
*Pour approfondir la doctrine du harnais et la gestion de la Smart Zone, consulter l'[Architecture du harnais](/annexes/architecture-harnais). Pour parcourir les fiches détaillées des compétences, consulter le [Catalogue des 37 skills](/annexes/catalogue-skills).*

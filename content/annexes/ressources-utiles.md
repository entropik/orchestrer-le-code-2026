...
*Pour approfondir la sélection des briques logicielles et l'indépendance vis-à-vis des fournisseurs, consulte le [Chapitre 12 : Choisir ses outils et préserver son indépendance](/accessible/12-ecosysteme-et-independance). Pour la mise en place concrète des garde-fous, consulte l'[Architecture du harnais](/annexes/architecture-harnais). Pour continuer la veille au jour le jour, explore [Digest by Ooblik](https://digest.ooblik.com/).*

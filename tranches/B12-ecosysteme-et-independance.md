...
Statut : redaction. Chapitre rédigé conformément au périmètre, harmonisé avec le miroir A12.

## Mission

Rédiger la lecture ingénieure du thème 12 : Évaluer la portabilité effective des modèles et des outils, y compris MCP et l'inférence locale.

## Entrées

- [Chapitre à développer](../manuscrit/02-lecture-ingenieure/12-ecosysteme-et-independance.md).
- [Chapitre miroir](../manuscrit/01-lecture-accessible/12-ecosysteme-et-independance.md).
...
- Sources : O-MD §2, §4 ; I-MD §12.1 à §12.6. Les identifiants sont résolus dans l'[inventaire commenté](../analyse/01-corpus.md).
- Prérequis de rédaction : A12, B11 ; une amorce existante permet de commencer, une harmonisation des deux niveaux est exigée à la relecture.

## Périmètre

- Protocoles de génération, appels d'outils, JSON-RPC et MCP.
- Licence par artefact, modèle exact et provenance.
- Runtime, quantification, mémoire, débit et qualité.
- Autorisations des connecteurs, données sortantes et évaluation de migration.
...
- Exemple fil rouge : Définir un protocole comparatif et une matrice de permissions d'un connecteur Git en lecture seule.

...
Rédiger la lecture accessible du thème 12 : Comparer cloud et local selon l'usage, les coûts et les données plutôt que selon une promesse.

## Entrées

- [Chapitre à développer](../manuscrit/01-lecture-accessible/12-ecosysteme-et-independance.md).
- [Chapitre miroir](../manuscrit/02-lecture-ingenieure/12-ecosysteme-et-independance.md).
...
- Modèle, agent, moteur d'exécution et connecteur.
- Poids accessibles et liberté d'usage : des questions différentes.
- Cloud, local ou hybride : qui exploite quoi ?.
- Essayer sur ses tâches et garder une possibilité de sortie.
...
- Exemple fil rouge : Comparer deux solutions sur trois tâches factices, sans envoyer de données confidentielles.

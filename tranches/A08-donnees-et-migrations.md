...
Rédiger la lecture accessible du thème 08 : Comprendre pourquoi les données demandent une prudence différente de celle du code.

## Entrées

- [Chapitre à développer](../manuscrit/01-lecture-accessible/08-donnees-et-migrations.md).
- [Chapitre miroir](../manuscrit/02-lecture-ingenieure/08-donnees-et-migrations.md).
...
- Deux demandes simultanées et règle d'unicité.
- Changer progressivement le rangement.
- Sauvegarde, restauration et perte acceptable.
...
- Exemple fil rouge : Décrire une migration du statut du document sans empêcher l'ancienne version de fonctionner.

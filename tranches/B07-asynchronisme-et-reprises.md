...
Rédiger la lecture ingénieure du thème 07 : Analyser atomicité, livraison, déduplication et reprise des effets distribués.

## Entrées

- [Chapitre à développer](../manuscrit/02-lecture-ingenieure/07-asynchronisme-et-reprises.md).
- [Chapitre miroir](../manuscrit/01-lecture-accessible/07-asynchronisme-et-reprises.md).
...
- Sources : O-MD §1, §2, §12, §13 ; I-MD §6, §11.2, §11.3. Les identifiants sont résolus dans l'[inventaire commenté](../analyse/01-corpus.md).
...
- Blocage CPU, attente d'entrées-sorties et budgets de latence.
- File durable, worker, accusé de réception et reprise.
- Clé d'idempotence, portée, empreinte et durée de conservation.
- Outbox, retry borné, jitter, disjoncteur et quarantaine.
...
- Exemple fil rouge : Énumérer les fenêtres de crash entre transaction, publication, effet et accusé de réception.

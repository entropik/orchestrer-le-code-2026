...
Rédiger la lecture accessible du thème 09 : Autoriser une livraison en sachant quelle version part, comment la vérifier et comment arrêter.

## Entrées

- [Chapitre à développer](../manuscrit/01-lecture-accessible/09-livraison-et-production.md).
- [Chapitre miroir](../manuscrit/02-lecture-ingenieure/09-livraison-et-production.md).
...
- Local, vérification automatique, répétition et production.
- Construire une version identifiable.
- Secrets et configuration hors du code.
- Vérifier le parcours et préparer le retour.
...
- Exemple fil rouge : Remplir une fiche d'autorisation de livraison pour le dépôt de PDF.

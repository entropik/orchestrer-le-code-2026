...
Rédiger la lecture accessible du thème 03 : Écrire une demande que deux personnes peuvent comprendre et vérifier de la même manière.

## Entrées

- [Chapitre à développer](../manuscrit/01-lecture-accessible/03-besoin-et-contrats.md).
- [Chapitre miroir](../manuscrit/02-lecture-ingenieure/03-besoin-et-contrats.md).
...
- Sources : O-MD §3, §12 ; I-MD §3, §9.3, §10.2. Les identifiants sont résolus dans l'[inventaire commenté](../analyse/01-corpus.md).
...
- Décrire scénario, cas limites et exclusions.
- Nommer les règles qui restent toujours vraies.
- Garder la trace des décisions importantes.
...
- Exemple fil rouge : Écrire une fiche de réception de fichier avec cinq critères et trois exclusions.

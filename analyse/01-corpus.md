# Analyse du corpus et des versions

Analyse du 31 août 2026. Huit fichiers fournis, organisés en deux familles éditoriales. Les identifiants ci-dessous sont ceux utilisés dans toutes les fiches. Les empreintes et comptages reproductibles sont dans [inventaire.json](../sources/inventaire.json).

## Inventaire commenté

| ID | Document | Étendue observée | Rôle |
|---|---|---|---|
| O-MD | [manuel_orchestration_logicielle.md](../sources/originaux/manuel_orchestration_logicielle.md) | 14 chapitres, avant-propos et conclusion ; 8 226 mots par découpage sur les espaces | Référence pédagogique principale. |
| O-PDF | [manuel_orchestration_logicielle.pdf](../sources/originaux/manuel_orchestration_logicielle.pdf) | 31 pages ; environ 3 996 mots extraits | Version plus courte, pas un équivalent exhaustif du Markdown. |
| O1-PDF | [manuel_orchestration_logicielle (1).pdf](<../sources/originaux/manuel_orchestration_logicielle (1).pdf>) | 55 pages ; 8 285 mots extraits, en-têtes compris | Export développé, même progression générale que O-MD. |
| O2-PDF | [manuel_orchestration_logicielle (2).pdf](<../sources/originaux/manuel_orchestration_logicielle (2).pdf>) | 55 pages | Doublon binaire exact de O1-PDF. |
| S-PDF | [manuel_architecture_systemique_complet.pdf](../sources/originaux/manuel_architecture_systemique_complet.pdf) | 25 pages ; sommaire et fin couvrant les chapitres 1 à 9 | État antérieur du traité ; ne contient pas les chapitres 10 à 12. |
| S-MD | [MANUEL_ARCHITECTURE_SYSTEMIQUE_COMPLET.md](../sources/originaux/MANUEL_ARCHITECTURE_SYSTEMIQUE_COMPLET.md) | 10 chapitres ; 10 300 mots | Traité avec bibliothèque de prompts. |
| SF-MD | [MANUEL_ARCHITECTURE_SYSTEMIQUE_COMPLET_EDITION_FINALE.md](../sources/originaux/MANUEL_ARCHITECTURE_SYSTEMIQUE_COMPLET_EDITION_FINALE.md) | 11 chapitres ; 11 993 mots | Ajout exploitation, résilience, mémoire et reprise. |
| I-MD | [MANUEL_INGENIERIE_LOGICIELLE_2026_COMPLET.md](../sources/originaux/MANUEL_INGENIERIE_LOGICIELLE_2026_COMPLET.md) | 12 chapitres ; 13 214 mots | **Référence technique principale demandée par l'utilisateur.** |

...
- C'est durant cette phase que les termes flous sont nettoyés dans `CONTEXT.md` et que les éventuels [ADR](05-glossaire.md#adr) sont rédigés lorsqu'un arbitrage technique structurant et difficilement réversible émerge.

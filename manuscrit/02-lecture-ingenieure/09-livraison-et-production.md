...
- **O-MD §8** ([Manuel d'Orchestration Logicielle](../../sources/originaux/manuel_orchestration_logicielle.md)) : La transition du poste local au service réel, les configurations hors code, les artefacts immuables et le protocole Go/No-Go.
- **I-MD §8 et §10.2** ([Manuel d'Ingénierie Logicielle](../../sources/originaux/MANUEL_INGENIERIE_LOGICIELLE_2026_COMPLET.md)) : L'ingénierie CI/CD, les conteneurs multi-stage durcis, la terminaison TLS par reverse proxy et les déploiements Blue-Green avec sondes de santé.

Pour maîtriser l'observabilité en production, les métriques Prometheus, la centralisation des logs et la gestion des incidents, poursuis vers le chapitre suivant : **[B10 — Exploiter, observer et faire évoluer](../02-lecture-ingenieure/10-exploitation-et-evolution.md)**. Pour réviser les concepts sans outillage de programmation, consulte le miroir accessible : **[A09 — Passer du poste local à un service réel](../01-lecture-accessible/09-livraison-et-production.md)**.

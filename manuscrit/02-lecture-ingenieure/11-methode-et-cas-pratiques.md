...
- **O-MD §5, §11, §12, §13 et §14** ([Manuel d'Orchestration Logicielle](../../sources/originaux/manuel_orchestration_logicielle.md)) : La méthode ORCHESTRE, le point d'arrêt, la décomposition des cas pratiques et l'analyse de cause racine.
- **I-MD §9 et §10** ([Manuel d'Ingénierie Logicielle](../../sources/originaux/MANUEL_INGENIERIE_LOGICIELLE_2026_COMPLET.md)) : Le cadre KISS en six phases séquentielles, la bibliothèque opérationnelle de prompts et les matrices d'audit de Pull Requests.
- [Guide des workflows agentiques](../03-annexes/02-guide-des-workflows.md) : Formalisation des protocoles d'exécution et outillage des agents.

Pour étudier les arbitrages de souveraineté technologique, la gestion des modèles ouverts versus propriétaires, les protocoles MCP et l'optimisation du coût total de possession (TCO), poursuis vers le chapitre final : **[B12 — Choisir ses outils et préserver son indépendance](../02-lecture-ingenieure/12-ecosysteme-et-independance.md)**. Pour réviser les principes sans code, consulte le miroir accessible : **[A11 — Appliquer ORCHESTRE du besoin à la résolution](../01-lecture-accessible/11-methode-et-cas-pratiques.md)**.
